                    ...
                    <div class="col-md-8 offset-md-2">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">Silahkan masukkan data anggota</div>
                            </div>
                            <form action="{{ route('admin.anggota.store') }}" method="POST">
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="nama" id="nama" value="{{ old('nama') }}" placeholder="Anggara Putra" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label" for="email">Email</label>
                                        <div class="col-md-9">
                                            <input type="email" class="form-control" name="email" id="email" value="{{ old('email') }}" placeholder="anggra@gmail.com">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label" for="no_hp">Nomor Handphone</label>
                                        <div class="col-md-9">
                                            <input type="number" class="form-control" name="no_hp" id="no_hp" value="{{ old('no_hp') }}" placeholder="082-xxx-xxx-xxx">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-3 col-form-label" for="tempat_lahir">Tempat Lahir</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="tempat_lahir" id="tempat_lahir" value="{{ old('tempat_lahir') }}" placeholder="Makassar">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="number" class="form-control" name="tahun_dad" id="tahun_dad" value="{{ old('tahun_dad') }}" placeholder="2004" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="form-control" name="alamat" id="alamat" cols="30" rows="3" placeholder="Jl. Tirto Utomo Gg.4 No.47">{{ old('alamat') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                ...
                                <div class="card-footer">
                                    <a href="{{ route('admin.anggota.index') }}" class="btn btn-default">Batal</a>
