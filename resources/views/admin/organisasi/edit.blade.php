...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <x-content-header>
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.anggota.show', ['anggotum' => $organisasi->anggota_id]) }}">Detail Anggota</a></li>        
            <li class="breadcrumb-item active">Update Organisasi</li>        
        </x-content-header>
                ...
                <div class="row">
                    <div class="col-md-8 offset-md-2">
                        ...
                        <div class="card">
                            ...
                            <form action="{{ route('admin.organisasi.update', ['organisasi' => $organisasi->id]) }}" method="POST">
                                @csrf @method('PUT')
                                <div class="card-body">
                                ...
                                <div class="card-footer">
                                    <a href="{{ route('admin.anggota.show', ['anggotum' => $organisasi->anggota_id]) }}" class="btn btn-default">Batal</a>
